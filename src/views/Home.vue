<template>
  ...
  <div class="fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
    <video autoplay muted loop playsinline class="w-full h-full object-cover">
      <source src="../assets/logos/Rainbow Gradient Pink and Purple Virtual Background.mp4" type="video/mp4" />
    </video>
    <div class="absolute inset-0 bg-gradient-to-b from-black/30 via-black/10 to-white/0"></div>
  </div>
...
<nav class="mt-3 flex flex-wrap sm:flex-nowrap gap-4 items-center">
  <!-- Framer Website -->
  <a
    href="https://tessymugisha.framer.website/"
...
<a
  href="https://docs.google.com/document/d/1goHncsZmfnskWUtYJVqu5T78h9gQ_hbo39Iar-ZJL3Q/edit?tab=t.0"
  target="_blank" rel="noopener"
...
>
  ...
  <svg class="size-4 transition-transform group-hover:translate-x-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
    ...
    <section aria-labelledby="links-title" class="mt-10">
      <h2 id="links-title" class="text-2xl font-semibold">Find me on the internet</h2>
      <ul class="mt-4 grid grid-cols-5 sm:grid-cols-6 gap-4">
        <li class="flex">
          <a href="https://www.linkedin.com/in/tessy-mugisha-5334ba173/" target="_blank" rel="noopener" aria-label="LinkedIn" title="LinkedIn"
             class="inline-flex items-center p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600">
            <img :src="logoLinkedIn" alt="" class="h-6 w-6 opacity-80 hover:opacity-100 hover:scale-105 active:scale-95 transition" />
          </a>
        </li>
        <li class="flex">
          <a href="https://github.com/tessymugisha" target="_blank" rel="noopener" aria-label="GitHub" title="GitHub"
             class="inline-flex items-center p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900">
            <img :src="logoGitHub" alt="" class="h-6 w-6 opacity-80 hover:opacity-100 hover:scale-105 active:scale-95 transition" />
          </a>
        </li>
        <li class="flex">
          <a href="https://medium.com/@mugishatessy" target="_blank" rel="noopener" aria-label="Medium" title="Medium"
             class="inline-flex items-center p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900">
            <img :src="logoMedium" alt="" class="h-6 w-6 opacity-80 hover:opacity-100 hover:scale-105 active:scale-95 transition" />
          </a>
        </li>
        <li class="flex">
          <a href="https://www.youtube.com/@HeyTesssyy" target="_blank" rel="noopener" aria-label="YouTube" title="YouTube"
             class="inline-flex items-center p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-600">
            <img :src="logoYouTube" alt="" class="h-6 w-6 opacity-80 hover:opacity-100 hover:scale-105 active:scale-95 transition" />
          </a>
        </li>
        <li class="flex">
          <a href="mailto:mugishatessy@gmail.com" aria-label="Email" title="Email"
            ...
            <img :src="logoEmail" alt="" class="h-6 w-6 opacity-80 hover:opacity-100 hover:scale-105 active:scale-95 transition" />
          </a>
        </li>
      </ul>
    </section>
        ...
        >
          ...
          <div class="p-4">
            ...
            <div class="mt-3 flex flex-wrap gap-2 text-xs text-neutral-600">
              <span v-for="t in p.tags" :key="t" class="rounded-md bg-neutral-100 px-2 py-1 ring-1 ring-neutral-200">{{ t }}</span>
            </div>
          </div>
        </article>

          <article class="flex h-full flex-col items-center justify-center rounded-xl
    ...
    <section id="writing" class="mt-12">
      ...
      <ul class="mt-4 space-y-3">
        <li>
          <a href="#" class="group block rounded-lg px-3 py-2 bg-white/80 ring-1 ring-neutral-200 hover:bg-white hover:ring-neutral-300 transition
                             focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900">
            <span class="font-medium">SwiftUI nav bugs & what finally worked</span>
            <span class="block text-sm text-neutral-600 group-hover:underline">Root causes, fixes, and QA tips</span>
          </a>
        </li>
      </ul>
    </section>
    ...
    <footer class="mt-14 mb-2 text-sm text-neutral-600">
      <div class="text-center">
        <p class="italic text-md text-neutral-700">
          “Seek first the kingdom of God and all will be added to you” — Mt 6:33
        </p>
...
<div v-if="activeProject" class="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true">
  ...
  <!-- Slightly opaque card so text pops over any busy imagery -->
...
import shotIntake from '../assets/shots/intake_ai.webp' // add an image for the QR Intake project

const projects = ref([
{
  id: 'swiftui-nav-fix',
  title: 'iPad App — SwiftUI Nav Fix',
  byline: 'Software Engineer Intern · Compassion International',  
  ...
  image: shotSwiftUI,
  tags: ['SwiftUI', 'Xcode', 'QA', 'Internship'],                  // (added “Internship” tag)
  star: {
  ...
  links: {
    github: '',   // private repo -> leave blank
    live: '',
    docs: ''
  }
},

  {
    ...
    links: {
      github: 'https://github.com/TessyMugisha/CampusBuddy_V1',
      live: '',
      docs: ''
    }
  },
  {
    ...
    links: {
      github: 'https://github.com/TessyMugisha/pos-system',
      live: '',
      docs: ''
    }
  },
